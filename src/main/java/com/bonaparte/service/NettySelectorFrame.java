 ...
 */
public class NettySelectorFrame extends JFrame{
        ...
        private JFrame frame = new JFrame("NettySelectorFrame");// 窗体界面

        private String uname;// 用户姓名

        private NettySelectorClient service;// 用于与服务器交互

        private boolean isRun = false;// 是否运行

        public NettySelectorFrame(NettySelectorClient service, String uname) {
            this.isRun = true;
            this.uname = uname;
